...
<h2 class="my-4">Inspeccionar  Registro</h2>
  ...
  @method('PUT')  
    ...
    <div class="mb-3">
        ...
        value="{{$actorpelicula->id}}" id="exampleInputText1" aria-describedby="emailHelp" autocomplete="off">
    </div>
    
    <div class="mb-3">
        <label for="exampleInputEmail1" class="form-label">Actor</label>
        <input type="integer" name="calificacion" class="form-control"
        value="{{$actores->nombre}}" id="exampleInputText1" aria-describedby="emailHelp" autocomplete="off">
    </div>

    <div class="mb-3">
        <label for="exampleInputEmail1" class="form-label">Apellido Paterno</label>
        <input type="integer" name="calificacion" class="form-control"
        value="{{$actores->apellPat}}" id="exampleInputText1" aria-describedby="emailHelp" autocomplete="off">
    </div>

    <div class="mb-3">
        <label for="exampleInputEmail1" class="form-label">Apellido Materno</label>
        <input type="integer" name="calificacion" class="form-control"
        value="{{$actores->apellMat}}" id="exampleInputText1" aria-describedby="emailHelp" autocomplete="off">
    </div>
    ...
    <a href="/AP" class="btn btn-secondary">Volver</a>
  </form>
