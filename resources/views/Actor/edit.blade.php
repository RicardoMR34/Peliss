...
<h2>Actualizar  Registro</h2>
  ...
  @method('PUT')  
    ...
    <div class="mb-3">
        ...
        value="{{$actor->apellPat}}" aria-describedby="emailHelp" autocomplete="off">
    </div>
    <div class="mb-3">
        <label for="exampleInputEmail1" class="form-label">Apellido Materno</label>
        <input type="text" name="apellMat" class="form-control"
        value="{{$actor->apellMat}}" id="exampleInputText1" aria-describedby="emailHelp" autocomplete="off">
    </div>
    <div class="col-md-4 mb-3">
    <label for="inputState" class="form-label">Genero</label>
    <select id="inputState" name="genero" class="form-select" value="{{$actor->genero}}">
      <option selected>{{$actor->genero}}</option>
    ...
    <div class="col-5">
      <div class="input-group date" id="datepicker">
        <input type="date" name="fechaNac" class="form-control" id="date" value="{{$actor->fechaNac}}"/>
      </div>
    </div>
    </div>
    <br>
